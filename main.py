...
def display_header():
    header_lines = [
        ...
        f"{Fore.CYAN}██{Fore.YELLOW}  ║{Fore.CYAN}     ██{Fore.YELLOW}  ║{Fore.CYAN}   ██{Fore.YELLOW}  ║{Fore.CYAN}  ██{Fore.YELLOW} ║             ██{Fore.YELLOW} ╗   ██{Fore.YELLOW}  ║",
        f"{Fore.GREEN} ██{Fore.YELLOW}  ║{Fore.GREEN}   ██{Fore.YELLOW}  ║   ██{Fore.YELLOW}  ║{Fore.GREEN}   ██{Fore.YELLOW} ║             ██{Fore.YELLOW}  ║   ██{Fore.YELLOW}  ║",
        f"{Fore.GREEN}  ██{Fore.YELLOW}  ╚═{Fore.GREEN}█████{Fore.YELLOW}═╝ ██  ║{Fore.GREEN}    ██{Fore.YELLOW} ║             ██{Fore.YELLOW} ║   ██{Fore.YELLOW}  ║",
        f"{Fore.GREEN}     ███{Fore.YELLOW}   ║{Fore.GREEN}  ███  ║{Fore.GREEN}     ████████████████{Fore.YELLOW}  ║   ██{Fore.YELLOW} ║",
        f"{Fore.YELLOW}      ╚═══╝   ╚═══╝           ╚══════════════╝    ╚═══╝",
        f"{Fore.YELLOW} 
        f"{Fore.YELLOW}
        f"{Fore.YELLOW}═══════════════════════════════════════════════════════════════════════════",

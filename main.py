...
def display_header():
    header_lines = [
        ...
        f"{Fore.RED}██{Fore.YELLOW}  ║{Fore.RED}              ██{Fore.YELLOW}  ║{Fore.RED} ██  ║             ██{Fore.YELLOW} ║{Fore.RED}   ██{Fore.YELLOW} ║",
        f"{Fore.RED}██{Fore.YELLOW}  ║{Fore.RED}              ██{Fore.YELLOW}  ║{Fore.RED} ██  ║             ██{Fore.YELLOW} ║{Fore.RED}   ██{Fore.YELLOW}  ║",
        f"{Fore.CYAN}██{Fore.YELLOW}  ║{Fore.CYAN}     ██{Fore.YELLOW}═╗{Fore.CYAN}     ██{Fore.YELLOW}  ║{Fore.CYAN}  ██{Fore.YELLOW} ║             ██{Fore.YELLOW} ║   ██{Fore.YELLOW}  ║",
        f"{Fore.CYAN}██{Fore.YELLOW}  ║{Fore.CYAN}     ██{Fore.YELLOW}  ║{Fore.CYAN}   ██{Fore.YELLOW}  ║{Fore.CYAN}  ████████████████    ╝   ██{Fore.YELLOW} ║",
        f"{Fore.CYAN}██{Fore.YELLOW}  ║{Fore.CYAN}     ██{Fore.YELLOW}  ║{Fore.CYAN}   ██{Fore.YELLOW}  ║{Fore.CYAN}  ██{Fore.YELLOW} ║             ██{Fore.YELLOW} ╗{Fore.GREEN}   ██{Fore.YELLOW}  ║",
        f"{Fore.GREEN} ██{Fore.YELLOW}  ║{Fore.GREEN}   ██{Fore.YELLOW}  ║   ██{Fore.YELLOW}  ║{Fore.GREEN}   ██{Fore.YELLOW} ║             ██{Fore.YELLOW}  ║{Fore.GREEN}  ██{Fore.YELLOW}  ║",
        f"{Fore.GREEN}  ██{Fore.YELLOW}  ╚═{Fore.GREEN}█████{Fore.YELLOW}═╝ ██  ║{Fore.GREEN}    ██{Fore.YELLOW} ║{Fore.GREEN}             ██{Fore.YELLOW} ║{Fore.GREEN}   ██{Fore.YELLOW}  ║",
